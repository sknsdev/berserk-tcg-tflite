...
╚══════════════════════════════════════════════════════════════╝""")
    ...
    def show_main_menu(self):
        ...
        print(" 10. Проверить изображения на повреждения")
        print()
        print("🤖 ОБУЧЕНИЕ И ТЕСТИРОВАНИЕ:")
        print(" 11. Обучить модель (базовый датасет)")
        print(" 12. Обучить модель (аугментированный датасет)")
        print(" 13. Тестировать модель")
        print(" 14. Запустить веб-демо")
        print()
        print("🚀 АВТОМАТИЧЕСКИЕ РЕЖИМЫ:")
        print(" 15. Полный цикл (базовый)")
        print(" 16. Полный цикл (с аугментацией)")
        print()
        print("ℹ️  ИНФОРМАЦИЯ:")
        print(" 17. Показать информацию о проекте")
        print(" 18. Показать статус проекта")
        print()
        print("  0. Выход")
        print()
    
    def run_script(self, script_command, description=None):
        """Запускает скрипт и показывает результат"""
        if description:
            print(f"\n🔄 {description}...")
        else:
            print(f"\n🔄 Запуск {script_command}...")
        ...
        try:
            ...
            # Запускаем процесс без перехвата вывода для немедленного отображения
            result = subprocess.run(full_command, text=True)
            
            print("-" * 50)
            if result.returncode == 0:
                print(f"✅ {script_command} выполнен успешно")
            else:
                print(f"❌ Ошибка при выполнении {script_command} (код: {result.returncode})")
            ...
            print(f"\n❌ Ошибка запуска {script_command}: {e}")
            return False
...
• Автоматизация каталогизации коллекций""")
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                choice = input("Выберите действие (0-18): ").strip()
                ...
                if choice == '0':
                    ...
                    self.run_script('check_images.py', 'Проверка изображений на повреждения')
